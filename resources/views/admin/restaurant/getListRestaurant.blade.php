        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body table-responsive p-0  mailbox-messages">
              	<table class="table table-hover ">
              		...
              		<tbody>              			
              			@if(count($data_list_restaurant) > 0)
              			@foreach($data_list_restaurant as $data)
                      ...
                      <td>{{$data -> id}}</td>
              				<td><a href="{{route('restaurants.edit',['restaurant'=>$data -> id])}}">{{$data -> name}}</a></td>              				
                      <td>{{$data -> address}}</td>
            ...
            <!-- /.card-body -->
              <div class="card-header">
                <div class="card-tools">                	
                	{!!$data_list_restaurant -> appends(request()->except('page')) -> links()!!}
                </div>
              </div>
          </div>
	...
	$(function () {
		...
		$(".delete").click(function(){
			...
			if(checked == true) {
				...
				var link = "{{route('restaurants.destroy', 'id')}}";
